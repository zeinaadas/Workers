        ...
        <div class="featured-post" style="min-height:200px;">
          ...
          <?php
            ...
            if ($username AND $userpass) {
                $finder = mysqli_query($connect, "SELECT loginname,password,id,fname,lname FROM clients WHERE loginname='" . $username . "' AND password='" . $userpass . "' AND clients.act=1") or die("mysql error");
                ...
                if (mysqli_num_rows($finder) != 0) {
                    ...
                    if ($username == $uname AND $userpass == $upass) {
                        $_SESSION['sessionnameclients'] = $uname;
                        $_SESSION['sessionpassclients'] = $upass;
                        $_SESSION['sessionidclients'] = $uid;
            ...
            <div class='login'  style="background-color:#aaa;width:333px;height:333px;border:1px solid #fff;float:center;margin:30px;padding:33px;border-radius:44px;">
                ...
                <form method='post' action='?page=login_client'>
