...
?>
<div class="title">البيانات الشخصية</div>
<?php

///////////////////////////////edit code
if (isset($_POST['editaddclients']) && $_POST['editaddclients'] == 'تعديل بيانات') {
    ...
    if (!empty($error)) {
        ...
        $update = mysqli_query($connect, "UPDATE clients SET fname='$fname',lname='$lname',email='$email',city='$city', "
...
$sql = mysqli_query($connect, "SELECT * FROM clients WHERE id='".$_SESSION['sessionidclients']."'");
...
<form method="post" enctype="multipart/form-data">
    <table dir="rtl" width="70%" class="tablein" style="padding:11px;min-height:520px;">
        ...
        <tr>
            <td colspan="4">
                <input type="submit" name="editaddclients" value="تعديل بيانات"/>
            </td>
        </tr>
    </table>
</form>
